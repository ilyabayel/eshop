defmodule Eshop.CartAndCheckout.Services.CalulateCartTotalsTest do
  use Eshop.DataCase, async: true

  alias Eshop.CartAndCheckout.Services.CalculateCartTotals
